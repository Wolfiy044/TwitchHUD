...
public final class EmoteTextureManager {
    ...
    public record EmoteTexture(ResourceLocation id, int width, int height) {
    }
    ...
    private void upload(String emoteId, byte[] bytes) {
        ...
        Minecraft.getInstance().execute(() -> {
            ...
            ResourceLocation id = ResourceLocation.fromNamespaceAndPath("twitchhud", "emote_" + emoteId.replaceAll("[^a-z0-9_]", "_"));
