...
public final class RoundedButton {
    ...
    public void render(GuiGraphicsExtractor context, int mouseX, int mouseY) {
        ...
        int textWidth = net.minecraft.client.Minecraft.getInstance().font.width(label);
        int textX = x + (width - textWidth) / 2;
        int textY = y + (height - 8) / 2;
        context.text(net.minecraft.client.Minecraft.getInstance().font, label, textX, textY, COLOR_TEXT, false);
    }
