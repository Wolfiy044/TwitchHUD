...
public final class RoundedButton {
    ...
    public void render(DrawContext context, int mouseX, int mouseY) {
        ...
        int textWidth = net.minecraft.client.MinecraftClient.getInstance().textRenderer.getWidth(label);
        int textX = x + (width - textWidth) / 2;
        int textY = y + (height - 8) / 2;
        context.drawText(net.minecraft.client.MinecraftClient.getInstance().textRenderer, label, textX, textY, COLOR_TEXT, false);
    }
